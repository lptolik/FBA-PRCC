...
Similar to Supplementary Figures \ref{fig:wt_trp_bs}, \ref{fig:wt_trp_bs_f}, \ref{fig:wt_trp_bf}, and \ref{fig:wt_trp_bf_f}, which show influence of the tryptophan influx on the wild-type model, Supplementary Figures \ref{fig:trpB_trp_bs}, \ref{fig:trpB_trp_bs_f}, \ref{fig:trpB_trp_bf}, and \ref{fig:trpB_trp_bf_f} show influence of the tryptophan influx on the $\Delta trpB$ model.
