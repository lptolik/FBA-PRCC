...
df$HMDF[is.na(df$HMDF)]<-""
df$ChEBI[is.na(df$ChEBI)]<-""
df$InChI[is.na(df$InChI)]<-""
df$KEGG[is.na(df$KEGG)]<-""
df$SEED[is.na(df$SEED)]<-""
df$BiGG[is.na(df$BiGG)]<-""
df$LipidMaps[is.na(df$LipidMaps)]<-""
df$MetaNetX[is.na(df$MetaNetX)]<-""
df$Reactome[is.na(df$Reactome)]<-""
df$PubChem[is.na(df$PubChem)]<-""
